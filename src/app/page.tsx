      ...
      <section className="bg-slate-50 text-[#0A1A2F] py-16">
        <div className="max-w-6xl mx-auto px-4 space-y-8">
          ...
          <div className="flex items-center gap-10 overflow-x-auto w-full mx-auto max-w-5xl py-6">
            <Image src="/clients/client1.png" width={120} height={120} alt="client1" />
            <Image src="/clients/client2.png" width={120} height={120} alt="client2" />
            <Image src="/clients/client3.png" width={120} height={120} alt="client3" />
            <Image src="/clients/client4.png" width={120} height={120} alt="client4" />
          </div>
